...
Prebuilt Windows installers and SHA-256 checksums are available in [GitHub Releases](https://github.com/EmberByt3/douyin-director/releases/latest). They do not require a separate Node.js installation, but still require FFmpeg and your own provider credentials.
